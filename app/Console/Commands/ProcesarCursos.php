...
class ProcesarCursos extends Command
{
    protected $signature = 'capacitacion:procesar-cursos';

    protected $description = 'Procesa cursos periódicos y no periódicos, cerrando programaciones y generando nuevas programaciones para cursos periódicos.';
