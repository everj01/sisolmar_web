...
class FileController extends Controller
{
    ...
    public function getPersonalTotal(Request $request)
    {
        ...
        if ($tieneFolio !== null) {
            $todosDatos = DB::select('EXEC SW_LISTAR_PERSONAL_X_SUCURSAL_TOTAL_V2 ?, ?, ?, ?, ?, ?, ?', [
            ...
            // Sin filtro DJ — usamos el SP V2 que ya trae el TotalRows integrado
            $data = DB::select('EXEC SW_LISTAR_PERSONAL_X_SUCURSAL_TOTAL_V2 ?, ?, ?, ?, ?, ?, ?', [
