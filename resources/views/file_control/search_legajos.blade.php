    ...
    <div id="dataDocsLeg1" class="card hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-3">
                <div>
                    <label class="text-default-800 text-sm font-medium inline-block mb-2">Cliente</label>
                ...
                <div>
                    <label class="text-default-800 text-sm font-medium inline-block mb-2">Cargo</label>
            ...
            <button type="button" class="btn bg-primary text-white" id="btnTraerFolios">Traer folios</button>
        </div>
        <div class="w-full px-5 py-2">
