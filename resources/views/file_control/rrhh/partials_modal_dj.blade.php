...
/* ── Bloque principal (grupo coloreado) ──────── */
...
<div id="modalDjGestion"
    ...
    <div class="-translate-y-5 hs-overlay-open:translate-y-0 hs-overlay-open:opacity-100 opacity-0 ease-in-out transition-all duration-500
        sm:w-full my-8 sm:mx-auto flex flex-col bg-white shadow-sm rounded"
        ...
        <div class="flex flex-col border border-default-200 shadow-sm rounded-lg pointer-events-auto">
            ...
            {{-- Header --}}
            <div class="flex justify-between items-center py-3 px-5 border-b border-default-200" style="background:#fafafa;">
                <h3 style="font-size:14px; font-weight:700; color:#111827; margin:0;">Declaración Jurada — Registro</h3>
                <button type="button" class="text-default-600 cursor-pointer" data-hs-overlay="#modalDjGestion">
            ...
            <div class="overflow-y-auto" style="padding: 16px 20px; max-height: 80vh;">
                ...
                <div class="dj-group">
                    ...
                    <div class="dj-group-body">
                                ...
                                <div style="display:flex; gap:14px; align-items:flex-start;">
                                    <div style="flex:1;">
                                        ...
                                        <input type="text" id="nombres_apellidos" name="nombres_apellidos"
                                            class="dj-input" placeholder="Ingrese nombres y apellidos completos" required>
                        ...
                        <div class="dj-section">
                            <div class="dj-section-header">
                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A10.97 10.97 0 0112 15c2.21 0 4.26.64 5.879 1.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                Datos Personales
                            </div>
                            <div class="dj-section-body">
                                <div class="dj-grid-3">
                                    <div>
                                        <label class="dj-label">DNI</label>
                                        <input type="text" id="dni" name="dni" maxlength="8" required class="dj-input" placeholder="12345678">
                                    </div>
                                    <div>
                                        <label class="dj-label">Caduca</label>
                                        <input type="date" id="caduca" name="caduca" class="dj-input">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" required class="dj-input">
                                    </div>
                                    <div>
                                        <label class="dj-label">Ciudad de Nacimiento</label>
                                        <input type="text" id="ciudad_nacimiento" name="ciudad_nacimiento"
                                            class="dj-input" placeholder="Lima, Arequipa, etc." style="text-transform:uppercase;">
                                    </div>
                                    <div>
                            ...
                            <div class="dj-section-body">
                                <div class="dj-grid-3">
                                    <div>
                                        ...
                                        <input type="text" id="celular" name="celular" maxlength="9" required class="dj-input" placeholder="999 999 999">
                                    </div>
                                    <div>
                                        <label class="dj-label">Correo electrónico</label>
                                        <input type="email" id="correo" name="correo" required class="dj-input" placeholder="ejemplo@correo.com">
                                    </div>
                                    <div>
                                        <label class="dj-label">WhatsApp</label>
                                        <input type="text" id="whatsapp" name="whatsapp" maxlength="9" class="dj-input" placeholder="999 999 999">
                                    </div>
                                </div>
                            </div>
                        </div>

                        {{-- Médica + Previsional (en fila) --}}
                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                                ...
                                <div class="dj-section-body">
                                    <div class="dj-grid-3">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" id="peso" name="peso" step="0.1" class="dj-input" placeholder="70">
                                        </div>
                                        <div>
                                            <label class="dj-label">Talla (m)</label>
                                            <input type="number" id="talla" name="talla" step="0.01" class="dj-input" placeholder="1.75">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dj-section">
                                ...
                                <div class="dj-section-body">
                                    <div class="dj-grid-3">
                                        <div>
                                            <label class="dj-label">Sistema</label>
                                ...
                                <div class="dj-section-body">
                                    <div class="dj-grid-2">
                                        <div>
                                            ...
                                            <select id="grado_instruccion" name="grado_instruccion" class="dj-select">
                                                ...
                                                @foreach ($grados as $grado)
                                                    <option value="{{ $grado->codigo }}">{{ $grado->descripcion }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select id="institucion" name="institucion" class="dj-select">
                                                ...
                                                @foreach ($instituciones as $inst)
                                                    <option value="{{ $inst->codigo }}">{{ $inst->descripcion }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" id="anio_egreso" name="anio_egreso" min="1950" max="2030" class="dj-input" placeholder="2020">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dj-section-body">
                                <div class="dj-grid-3">
                                    <div>
                                        ...
                                        <select id="departamento_actual" name="departamento_actual" class="dj-select"><option value="">—</option></select>
                                    </div>
                                    <div>
                                        <label class="dj-label">Provincia</label>
                                        <select id="provincia_actual" name="provincia_actual" class="dj-select"><option value="">—</option></select>
                                    </div>
                                    <div>
                                        <label class="dj-label">Distrito</label>
                                        <select id="distrito_actual" name="distrito_actual" class="dj-select"><option value="">—</option></select>
                                    </div>
                                </div>
                                <div>
                                    <label class="dj-label">Descripción</label>
                                    <textarea id="direccion_actual" name="direccion_actual" required class="dj-textarea" placeholder="Ingrese su dirección actual completa"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dj-section">
                            ...
                            <div class="dj-section-body">
                                <div class="dj-grid-3">
                                    <div>
                                        <label class="dj-label">Departamento</label>
                                        <select id="departamento_dni" name="departamento_dni" class="dj-select"><option value="">—</option></select>
                                    </div>
                                    <div>
                                        <label class="dj-label">Provincia</label>
                                        <select id="provincia_dni" name="provincia_dni" class="dj-select"><option value="">—</option></select>
                                    </div>
                                    <div>
                                        <label class="dj-label">Distrito</label>
                                        <select id="distrito_dni" name="distrito_dni" class="dj-select"><option value="">—</option></select>
                                    </div>
                                </div>
                                <div>
                                    <label class="dj-label">Descripción</label>
                            ...
                            <div class="dj-section-body">
                                <div class="dj-grid-3">
                                    <div>
                                        ...
                                        <input type="text" id="contacto_emergencia" name="contacto_emergencia" required class="dj-input" placeholder="Juan Pérez García">
                                    </div>
                                    <div>
                                        <label class="dj-label">Celular</label>
                                        <input type="text" id="celular_emergencia" name="celular_emergencia" maxlength="9" required
                                            pattern="[0-9]{9}" class="dj-input" placeholder="999 999 999"
                                            oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                                    </div>
                                    <div>
                                        <label class="dj-label">Parentesco</label>
                                        <input type="text" id="parentesco_emergencia" name="parentesco_emergencia" required class="dj-input" placeholder="Madre, Hermano…">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="dj-section-body">
                                <div class="dj-grid-3">
                                    <div>
                                        ...
                                        <input type="text" id="ocupacion_principal" name="ocupacion_principal"
                                            class="dj-input" placeholder="Ej. Agente de Seguridad" style="text-transform:uppercase;">
                                    </div>
                                    <div>
                                        <label class="dj-label">Experiencia (años)</label>
                                        <input type="number" id="experiencia_anios" name="experiencia_anios" min="0" class="dj-input" placeholder="0">
                                    </div>
                                    <div>
                                    ...
                                    <div class="dj-grid-2">
                                        <div>
                                            ...
                                            <input type="text" id="familiar_nombre" name="familiar_nombre"
                                                class="dj-input" placeholder="Nombre y apellidos" style="text-transform:uppercase;">
                                        </div>
                                        <div>
                                            <label class="dj-label">Parentesco</label>
                        ...
                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                            ...
                            <div class="dj-section">
                                ...
                                <div class="dj-section-body">
                                    ...
                                    <div id="institucion_container" class="hidden">
                                        <label class="dj-label">Institución SUCAMEC</label>
                            ...
                            <div class="dj-section">
                                ...
                                <div class="dj-section-body">
                                    <div class="dj-grid-3">
                                        <div>
                                            <label class="dj-label">Licencia de Arma</label>
                                            <input id="licencia_arma" name="licencia_arma" class="dj-input" placeholder="Nº de licencia...">
                                        </div>
                                        <div>
                                ...
                                <div class="dj-section-body">
                                    <div class="dj-grid-2">
                                        <div>
                                            ...
                                            <input type="text" id="brevete" name="brevete" class="dj-input" placeholder="Número de brevete">
                                        </div>
                                        <div>
                                            <label class="dj-label">Clase</label>
                                            <input type="text" id="clase_brevete" name="clase_brevete" class="dj-input" placeholder="Ej: A-I, B-IIb">
                                        </div>
                                        <div>
                                            <label class="dj-label">Tipo de Vehículo</label>
                                            <input type="text" id="tipo_vehiculo" name="tipo_vehiculo" class="dj-input" placeholder="Tipo de vehículo">
                                        </div>
                                        <div>
                                ...
                                <div class="dj-section-body">
                                    <div class="dj-grid-3">
                                        <div>
                                            ...
                                            <input type="text" id="empresa_anterior" name="empresa_anterior" class="dj-input" placeholder="Nombre de la empresa">
                                        </div>
                                        <div>
                                            <label class="dj-label">Cargo</label>
                                            <input type="text" id="cargo_anterior" name="cargo_anterior" class="dj-input" placeholder="Cargo">
                                        </div>
                                        <div>
                                            <label class="dj-label">Duración (años)</label>
                                            <input type="number" id="duracion_anterior" name="duracion_anterior" min="0" step="0.5" class="dj-input" placeholder="2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                </div>{{-- /dj-group DATOS LABORALES --}}


                {{-- ═══════════════════════════════════════════
                     BLOQUE 3: DATOS FAMILIARES
                ════════════════════════════════════════════ --}}
                                ...
                                <div id="familyContainer" style="display:flex; flex-direction:column; gap:8px;">
                                    ...
                                    <div class="family-row" style="display:grid; grid-template-columns:1fr 2fr 1fr auto; gap:8px; align-items:end; background:#f9fafb; border:1px solid #e5e7eb; border-radius:6px; padding:8px 10px;">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="apellidosNombres[]" class="dj-input" placeholder="Apellidos y nombres completos">
                                        </div>
                                        <div>
                                            <label class="dj-label">Fecha de Nacimiento</label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Familiar en empresa (condicional) ─────────
    ...
    // ── SUCAMEC observación (condicional) ─────────
    ...
    // ── Ocupación Alterna (tabla dinámica) ────────
