...
<div class="px-6 py-6">
        ...
        <div x-data="modalGestionCurso()"
            ...
            <div x-show="showModal" x-cloak
                ...
                <div
                    ...
                    x-data="formCursoGestion()" @submit.prevent
                    ...
                    <div
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-default-900"
                                x-text="codigo ? 'Actualizar Curso' : 'Datos del curso'"></h3>
                            <p class="text-sm text-default-500 mt-1">Registro y actualización de cursos del plan de capacitación</p>
                        </div>
                    ...
                    <div
                        ...
                        <button type="button" id="btnGestionEditar" onclick="editarFormGestionCurso()"
                            class="hidden h-9 px-4 inline-flex items-center justify-center gap-1.5 bg-amber-500 text-white text-sm font-medium rounded-lg shadow-sm hover:bg-amber-600 transition cursor-pointer">
    ...
    <script>
        /**
         * Gestión de paneles y modal de Registro/Actualización de Curso.
         * Mismo patrón de componente Alpine que modalListaMatriculados (consulta_matriculas).
         */
