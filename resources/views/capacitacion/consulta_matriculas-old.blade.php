                ...
                <div class="flex flex-col"
                    ...
                    <div class="relative">
                        <button
                            ...
                            <span class="block truncate" x-text="selected ? selected.descripcion : '-- Todos --'"></span>
                        ...
                        <div x-show="open"
                            ...
                            <div class="p-2 border-b border-gray-100 bg-gray-50 flex-shrink-0 relative">
                                <i class="i-tabler-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xs z-10"></i>
                                <input
                                    type="text"
                                    x-model="search"
                                    placeholder="Buscar..."
    ...
    <div class="card lg:col-span-2 backdrop-blur-md bg-white/90 border border-white/20 shadow-xl rounded-2xl overflow-hidden" x-data="{ tabActivo: 'personal' }" @cambiar-tab-curso.window="tabActivo = 'curso'">
        ...
        <div x-show="tabActivo === 'personal'" class="p-4" x-transition>
            <div class="flex flex-wrap items-center gap-4 mb-4">
                <div class="w-full md:w-1/3 relative">
                    ...
                    <input type="text" id="txtBusquedaPersonal" class="form-input w-full py-2 text-sm rounded-xl border-gray-200 shadow-sm focus:ring-primary/20"
                        style="padding-left: 2.2rem !important;"
                        placeholder="Buscar personal por DNI o Nombres..." autofocus>
                </div>
                    ...
                    <div class="flex flex-col"
                        ...
                        <div class="relative">
                            <button
                                ...
                                <span class="block truncate text-gray-700" x-text="selected ? selected.descripcion : 'Todas las sucursales'"></span>
                            ...
                            <div x-show="open"
                                ...
                                <div @click="selectOption(null)"
                                    ...
                                    <span class="block truncate font-bold text-gray-400 uppercase text-[10px] tracking-widest">Todas las sucursales</span>
                                </div>
                                ...
                                <div class="overflow-y-auto custom-scrollbar flex-1">
                                    <template x-for="option in filteredOptions" :key="option.codigo">
                                        <div @click="selectOption(option)"
                                            ...
                                            :class="{ 'bg-primary/10 font-bold text-primary': selected && selected.codigo === option.codigo }">
                                            <span class="block truncate" x-text="option.descripcion"></span>
                                            <span x-show="selected && selected.codigo === option.codigo" class="absolute inset-y-0 right-0 flex items-center pr-4 text-primary">
        ...
        <div x-show="tabActivo === 'curso'" class="p-4" x-transition style="display: none;">
            ...
            <div class="space-y-4 mb-6" id="filtrosMatriculaContainer" style="display: none;">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50/50 p-4 rounded-2xl border border-gray-100">
                    <div class="relative">
                        <i class="i-tabler-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg z-10"></i>
                        <input type="text" id="buscarMatricula" class="form-input w-full py-2.5 rounded-xl border-gray-200 shadow-sm focus:ring-primary/20"
                        ...
                        <div class="flex flex-col"
                            ...
                            <div class="relative">
                                <button
                                    ...
                                    <span class="block truncate text-gray-700 font-medium" x-text="selected ? selected.descripcion : 'Todas las Sedes'"></span>
                                    <i class="i-tabler-chevron-down text-gray-400 text-xs"></i>
                                </button>
                                ...
                                <div x-show="open"
                                    ...
                                    <div @click="selectOption(null)"
                                        class="cursor-pointer select-none relative py-2 pl-3 pr-9 text-gray-900 hover:bg-gray-50 text-sm border-b border-gray-50 flex-shrink-0">
                                        <span class="block truncate font-bold text-gray-400 uppercase text-[10px] tracking-widest">Todas las Sedes</span>
                                    </div>
    ...
    <div
        ...
        <div class="flex flex-col border border-default-200 shadow-lg rounded-lg pointer-events-auto">
            ...
            <div class="p-4">
                ...
                <div class="mb-3">
                    <div class="relative">
                        <i class="i-tabler-search absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm z-10"></i>
                        <input type="text" id="buscarPersonalModal" class="form-input w-full py-1.5 text-[13px] rounded-md border-gray-300 focus:ring-1 focus:ring-indigo-500"
