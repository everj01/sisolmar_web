                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin:20px 0;">
                                <tr>
                                    ...
                                    <td style="background-color:#f8f9fa; padding:15px; padding-bottom:20px;">
                                        <p style="margin:0 0 8px;"><strong style="color:#004080;">Curso:</strong> {{ $course_name }}</p>
                                        <p style="margin:0 0 8px;"><strong style="color:#004080;">Código:</strong> {{ $course_shortname }}</p>
                                        <p style="margin:0;"><strong style="color:#004080;">Inicio:</strong> {{ $enrolment_start_date }}</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin:15px 0;">Le recordamos que el curso ya se encuentra disponible. Le invitamos a ingresar a la plataforma y dar inicio a su capacitación.</p>
